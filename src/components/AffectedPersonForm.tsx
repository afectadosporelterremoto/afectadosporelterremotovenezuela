...
import { registerAffectedPerson, isCurrentUserAdmin, submitInformationReport } from "@/app/actions";
...
export default function AffectedPersonForm() {
  ...
  const handleInfoSubmit = async (e: React.FormEvent) => {
    ...
    let relatedType: "affected" | "missing" | "rescued" = "affected";
    if (duplicateData.type === "desaparecido") relatedType = "missing";
